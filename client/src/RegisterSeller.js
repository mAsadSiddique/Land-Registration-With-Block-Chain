...
class RegisterSeller extends Component {
  ...
  registerSeller = async () => {
    ...
    if (
      ...
      alert("CNIC Number should be 12 digits long!");
    } else if (this.state.panNumber.length != 10) {
      alert("Password Number should be a 10 digit unique number!");
          ...
          <div className="auth-inner">
            <div className="App">
              ...
              <div className="form">
                ...
                <FormGroup>
                  <div className="form-label">Enter CNIC No --</div>
                  <div className="form-input">
                    <FormControl
                      input="text"
                ...
                <FormGroup>
                  <div className="form-label">Enter Password no --</div>
                  <div className="form-input">
                    <FormControl
                      input="text"
                ...
                <FormGroup>
                  <label>Add your CNIC Card (PDF Format)</label>
